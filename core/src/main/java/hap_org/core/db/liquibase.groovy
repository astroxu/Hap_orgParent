//package hap_org.core.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "hap_org/core/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType,["com/hand/hap","hap_org/core"] ,["table", "data", "patch"])
